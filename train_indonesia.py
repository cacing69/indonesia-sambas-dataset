...
class TranslationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        src_text = self.data.iloc[idx]['sambas']
        tgt_text = self.data.iloc[idx]['indonesia']
...
training_args = TrainingArguments(
    output_dir="./models/t5_finetuned_indonesia",  # Folder untuk menyimpan checkpoint
...
model.save_pretrained("./models/t5_finetuned_indonesia")
tokenizer.save_pretrained("./models/t5_finetuned_indonesia")